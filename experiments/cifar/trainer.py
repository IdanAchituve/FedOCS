...
from experiments.cifar.data import CIFARData
...
#       Dataset Args        #
#############################
parser.add_argument("--data-name", type=str, default="cifar10", choices=['cifar10', 'cifar100'])
parser.add_argument("--data-path", type=str, default="./dataset", help="dir path for CIFAR dataset")
...
parser.add_argument('--network', type=str, default='mobilenetV2',
                    choices=['lenet', 'lenet2', 'mobilenetV2', 'efficientnetV2'], help="network to use")
...
exp_name = f'FedOCS-CIFAR_{args.data_name}_num-clients_{args.num_clients}_' \
...
# get data
###############################
data = CIFARData(data_dir=args.data_path, data_name=args.data_name)
